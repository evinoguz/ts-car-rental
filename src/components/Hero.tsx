    ...
    <div className="hero">
      <div className="pt-36 padding-x flex-1 max-h-[920px]">
        ...
        <p className="hero__subtitle">
          Altın standartta hizmetle unutulmaz bir yolculuğa hazır mısınız? Araç kiralama deneyiminizi Altın Seçenekleri ile
          taçlandırarak her anınıza özel kılabilirsiniz.
        </p>
